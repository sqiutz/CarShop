...
insert into tbl_user set user_name = 'SA-01', is_admin = 0, passwd = 'passw0rd', is_valid = 1, group_id = 5;
insert into tbl_user set user_name = 'SA-02', is_admin = 0, passwd = 'passw0rd', is_valid = 1, group_id = 5;
insert into tbl_user set user_name = 'SA-03', is_admin = 0, passwd = 'passw0rd', is_valid = 1, group_id = 5;
insert into tbl_user set user_name = 'SA-04', is_admin = 0, passwd = 'passw0rd', is_valid = 1, group_id = 5;
...
insert into tbl_order set status=1, registerNumber='B-002', queueNumber='B1002AC';
insert into tbl_order set status=1, registerNumber='B-001', queueNumber='B1003AC';
insert into tbl_order set status=1, registerNumber='N-001', queueNumber='B1001NC';
