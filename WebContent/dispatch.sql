...
CREATE TABLE `TBL_PROPERTY` (
  ...
  `pkey` varchar(48) NOT NULL UNIQUE,
  `pvalue` varchar(48) NOT NULL,
  PRIMARY KEY (`id`)
...
insert into tbl_order set status=0, registerNumber='B-001', queueNumber='B1831TOK', estimationTime=4;
